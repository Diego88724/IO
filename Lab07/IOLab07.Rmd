...
if(knp$valid(solini)==F){    #Definir solución inicial 
  solini <- knp$correct(solini) #hay que partir de una solución inicial válida
}
solopt <- solini
zopt <- abs(knp$evaluate(solopt))    #Calcular zopt
